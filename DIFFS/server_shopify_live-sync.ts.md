# Diff: server/shopify/live-sync.ts

```diff
--- original_reference/server/shopify/live-sync.ts	2026-07-06 18:23:36.000000000 +0000
+++ audit/server/shopify/live-sync.ts	2026-07-09 19:26:12.626918139 +0000
@@ -75,83 +75,155 @@
     .join(" ");
 }
