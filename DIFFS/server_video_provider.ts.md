# Diff: server/video/provider.ts

```diff
--- original_reference/server/video/provider.ts	2026-07-06 18:23:36.000000000 +0000
+++ audit/server/video/provider.ts	2026-07-07 05:51:47.946245756 +0000
@@ -75,14 +75,39 @@
   ];
 }
